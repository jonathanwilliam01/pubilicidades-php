...
if (isset($_POST['encerrar']) && isset($_POST['id_encerrar'])) {
  ...
  $sqlUpdate = "UPDATE publicidades SET dt_fim = current_date - INTERVAL '1 day', padrao = 0 WHERE id = :id";
...
case when dt_fim < current_date then 'vencida' 
     when dt_fim >= current_date then 'valida' end as validade, padrao
from publicidades";

$filtroAtiv = " where dt_fim >= current_date";
$publiAtivas = $selectPublicidades . $filtroAtiv;

$filtroIn = " where dt_fim < current_date and padrao <> 1";
